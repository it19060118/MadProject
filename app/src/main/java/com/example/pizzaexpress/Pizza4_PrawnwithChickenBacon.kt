...
class Pizza4_PrawnwithChickenBacon : AppCompatActivity() {
    private var qty: TextView? = null
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_pizza4__prawnwith_chicken_bacon)
    ...
    fun onAlignmentSelected(view: View?) {
        ...
        when (radioGroup.checkedRadioButtonId) {
            R.id.size_small -> price.text = "Rs. 400"
            R.id.size_medium -> price.text = "Rs. 710"
            R.id.size_large -> price.text = "Rs. 1490"
        }
    }
