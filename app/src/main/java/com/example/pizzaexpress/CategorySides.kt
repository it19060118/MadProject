...
class CategorySides : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val backImgBtn = findViewById<ImageView>(R.id.imageButton)
        ...
        val cardObj = findViewById<CardView>(R.id.sideCard1)
        cardObj.setOnClickListener {
            val intObj = Intent(applicationContext, Sides1_chickenWingsBbq::class.java)
