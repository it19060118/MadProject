...
class Displayed_Option_list : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        continueBtn?.setOnClickListener(View.OnClickListener {
            startActivity(
                Intent(
                    applicationContext, DialogQuantityActivity::class.java
                )
            )
        })
        ...
        val backImgBtn = findViewById<ImageView>(R.id.floatingActionButton6)
        backImgBtn.setOnClickListener {
            val launchActivity1 = Intent(applicationContext, Offer1Options::class.java)
