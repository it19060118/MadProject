...
class Pizza2_MeatLoversChicken : AppCompatActivity() {
    ...
    fun onAlignmentSelected(view: View?) {
        ...
        when (radioGroup.checkedRadioButtonId) {
            R.id.size_small -> price.text = "Rs. 900"
            R.id.size_medium -> price.text = "Rs. 1200"
            R.id.size_large -> price.text = "Rs. 2500"
        }
    }
